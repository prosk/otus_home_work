package com.myprog.unittests.assertions;
...
public class Assertions {
    ...
    public static void assertRange(int expectedMin, int expectedMax,  int actual) {
        if (actual < expectedMin || actual > expectedMax) {
            throw new AssertionError(String.format("Expected from %d to %d, actual %d",
